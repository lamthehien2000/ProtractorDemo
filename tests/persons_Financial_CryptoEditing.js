...
describe('Financial Page', function(){
    ...
    it('Financial - Add and Approve', function(){
        ...
        financialPage.dropdown_Crypto_select();
        browser.sleep(3000);
...
// Trading history - exchange(4)
        ...
        let fpath4 = path3.resolve(__dirname, filePath4);
        browser.ignoreSynchronization = true;
        browser.sleep(2000);
...
// Trading history - external wallet(5)
        ...
        //  browser.sleep(5000);
        saveButton_Pending = element.all(by.css('.button.no-border.is-info.is-outlined')).get(2);
